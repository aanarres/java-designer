...
class ParameterPropertyModel extends PropertyModel implements IPropertyModel {
	...
	protected void setCollection(ModelElement element, String value) {
		try {
			...
			try {
				ModelUtils.setFirstTagParameter (getModule().getModelingSession(), element, IOtherProfileElements.MODULE_NAME, IOtherProfileElements.FEATURE_TYPE, value);
	...
	public ParameterPropertyModel(IModule module, Parameter parameter) {
		super (module);
