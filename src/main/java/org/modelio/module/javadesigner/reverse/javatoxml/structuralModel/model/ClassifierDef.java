...
public class ClassifierDef extends StructuralTree implements Type {
	...
	public ClassifierDef(final String name) {
		super(name);
		this.setKind(ClassifierDefKind.UNKNOWN);
	...
	public void addTemplateParameter(ClassTemplateParameter aTmplPar) {
	...
	public void addInherits(ClassifierDef aInherit) {
    ...
    public void setKind(ClassifierDefKind kind) {
        this.kind = kind;
    }
