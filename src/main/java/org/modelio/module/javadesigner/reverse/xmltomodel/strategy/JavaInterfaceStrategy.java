...
public class JavaInterfaceStrategy extends InterfaceStrategy {
    ...
    public JavaInterfaceStrategy(IModelingSession session, ReverseStrategyConfiguration reverseConfig) {
        super (session);
        this.reverseConfig = reverseConfig;
    }

    @Override
    public List<MObject> updateProperties(JaxbInterface jaxb_element, Interface modelio_element, MObject owner, IReadOnlyRepository repository) {
        ...
        try {
            ...
            JavaDesignerModule.logService.error(Messages.getString ("Error.StereotypeNotFound", JavaDesignerStereotypes.JAVAINTERFACE)); //$NON-NLS-1$
        }
     ...
     */
    private void handleMultipleTags(JaxbInterface jaxb_element, Interface modelio_element, IReadOnlyRepository repository) {
    ...
    @Override
    public void postTreatment(JaxbInterface jaxb_element, Interface modelio_element, IReadOnlyRepository repository) {
    ...
    private void computeJavaDoc(Interface modelio_element, IReadOnlyRepository repository) throws ExtensionNotFoundException {
        String noteType;
