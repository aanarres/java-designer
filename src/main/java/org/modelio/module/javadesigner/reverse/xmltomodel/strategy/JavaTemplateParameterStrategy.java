...
public class JavaTemplateParameterStrategy extends TemplateParameterStrategy {
    ...
    public JavaTemplateParameterStrategy(IModelingSession session) {
        super(session);
    }

    @Override
    public void postTreatment(JaxbTemplateParameter jaxb_element,
            TemplateParameter modelio_element,
