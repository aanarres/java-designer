...
public class StructuralModelUtils {
     ...
     * @throws NameCollisionException when a structural element already exists in the parent but is not a PackageDef
     */
    public static PackageDef addPackage(String aPackageShortName, StructuralTree parent) throws NameCollisionException {
     ...
     */
    public static PackageDef addPackageHierarchy(String aFqnPackageName, PackageDef root) throws NameCollisionException {
     ...
     */
    static PackageDef getPackage(String aPackageShortName, PackageDef aParent) {
        assert aParent != null;
     ...
     * @throws NameCollisionException 
     */
    public static ClassifierDef addClass(String className, StructuralTree parent)  {
        assert parent != null;
        ...
        ClassifierDef cDef = new ClassifierDef(className);
     ...
     */
    static StructuralTree getStructuralTree(String aFullQualifiedName, PackageDef root) {
     ...
     * @return
     */
    static ClassifierDef getClassifier(String aName, StructuralTree startElement) {
     ...
     */
    private static List<ClassifierDef> getAllClassifiers(final String aShortName, final List<? extends StructuralTree> possibleOwners, final StructuralTree aRoot) {
        // short name only !
        ...
        for (StructuralTree  owner : possibleOwners) {
            if (owner instanceof ClassifierDef) {
                ...
                if (inherit != null) {
                    resultList.addAll(getAllClassifiers(aShortName, inherit, aRoot));
                }
            }
        }
        return resultList;
     ...
     * @return
     */
    private static boolean isVisible(ClassifierDef anElt, ClassifierDef aRoot) {
    ...
    static ClassTemplateParameter addClassTemplateParameterDef(String parname, ClassifierDef classdef) {
    ...
    public static ClassTemplateParameter getClassTemplateParameter(String aName, StructuralTree owner) {
        assert owner != null;
        if (owner instanceof ClassifierDef) {
