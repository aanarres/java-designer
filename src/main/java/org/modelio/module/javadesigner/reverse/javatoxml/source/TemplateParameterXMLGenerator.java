...
public abstract class TemplateParameterXMLGenerator extends XMLGenerator {
	 ...
	 */
	@Override
	public void generateXML(final ASTTree ast, final Context ctx)
	 ...
	 */
	private void generateParameter(final ASTTree aParameter, final Context ctx)
	 ...
	 * 
	 * @param paramIdent
	 *            : ast node that carries the parameter name
	 * @throws IOException
	 */
	private void generateHeader(Tree paramIdent, final Context ctx)
			throws IOException {
	 ...
	 * @throws NameCollisionException 
	 */
	private void generateExtends(ASTTree gextends, final Context ctx) throws IOException, NameCollisionException {
	 ...
	 * @throws NameCollisionException 
	 */
	private void generateExtendsOfNonGeneric(ASTTree extendedType, final Context ctx)
			throws IOException, NameCollisionException {
	...
	abstract protected Identified getIdentifiedTemplateParameter(final String templateName, final Context ctx);
