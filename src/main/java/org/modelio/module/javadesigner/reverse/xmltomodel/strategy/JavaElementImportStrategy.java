...
public class JavaElementImportStrategy extends ElementImportStrategy {
    ...
    public JavaElementImportStrategy(IModelingSession session, ReverseStrategyConfiguration reverseConfig) {
        super (session);
        this.reverseConfig = reverseConfig;
    }

    @Override
    public ElementImport getCorrespondingElement(JaxbElementImport jaxb_element, NameSpace source, NameSpace target, IReadOnlyRepository repository) {
     ...
     */
    private boolean isStatic(JaxbElementImport jaxb_element) {
     ...
     */
    @Override
    public void postTreatment(JaxbElementImport jaxb_element, ElementImport modelio_element, IReadOnlyRepository repository) {
    ...
    private boolean isImplicitlyGenerated(GeneralClass source, GeneralClass target) {
        // Template Parameter
    ...
    private boolean isWellKnownContainerImport(ModelElement aFeatureOrParameter, GeneralClass anImportedElt) { 
