...
class WellKnownContainerServicesWithAST extends WellKnownContainerServices {
	 ...
	 */
	private static ASTTree getGenericArgumentByIndex(ASTTree type, int index) {
	 ...
	 */
	protected static ASTTree getQualifierType(ASTTree type) {
	 ...
	 */
	protected static ASTTree getRealDestinationType(ASTTree type) {
		assert (type.getType() == JavaParser.TYPE) : "Internal error: unexpected input ast node type";
