...
public class XMLGeneratorFromSource {
    ...
    public XMLGeneratorFromSource(List<File> srcFiles, List<File> sourcepath, List<File> classpath, IReportWriter report, String encoding) {
        this.report = report;
     ...
     */
    public boolean generateModel(List<File> srcFiles, File outputFile, String encoding) throws IOException, NameCollisionException {
    ...
    private void generateElementXML(ASTTree root) {
        try {
