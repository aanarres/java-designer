...
class AnnotationAstServices {
	 ...
	 * 
	 * @param annotations
	 *            : set of annotation (typically return of getAnnotations(final
	 *            ASTTree rootNode))
	 * @param fqname
	 *            : annotation name to search. A full qualified name
	 ...
	 */
	public static String getName(ASTTree annotation) {
	 ...
	 */
	public static ASTTree getFirstParameter(ASTTree annotation) {
		ASTTree retval = null;
	 ...
	 *         no parameter
	 */
	public static String getFirstParameterValue(ASTTree annotation) {
	 ...
	 * 
	 * @param annotations
	 *            : the list of annotations to search, modified on return
	 * @return the string value of objid or null if not found
	 */
	public static String extractObjidValue(List<ASTTree> annotations) {
	 ...
	 */
	public static boolean extractDatatype(List<ASTTree> annotations) {
	 ...
	 */
	public static boolean extractDocumented(List<ASTTree> annotations) {
	 ...
	 */
	public static boolean extractInherited(List<ASTTree> annotations) {
	 ...
	 */
	public static String extractRetentionValue(List<ASTTree> annotations) {
	 ...
	 * @return the string value of Retention or null if not found
	 */
	public static List<String> extractTargetValues(List<ASTTree> annotations) {
