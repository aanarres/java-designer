...
public class IdentifierManager {
	 ...
	 * 
	 */
	public String declareReferenceIdentifier(Class<?> aClass) {
		assert aClass != null;
		return _declareReferenceIdentifier(aClass);
	}
	
	public String declareReferenceIdentifier(Identified anElt) {
		assert anElt != null;
	 ...
	 */
	public String defineIdentifier(Class<?> aClass) {
		assert aClass != null;
		return _defineIdentifier(aClass);
	}
	
	public String defineIdentifier(Identified anElt) {
		assert anElt != null;
	...
	private String _declareReferenceIdentifier(Object anObject) {
	...
	private String _defineIdentifier(Object anObject) {
