...
public class WellKnownContainerServices {
	 ...
	 */
	public static void loadContainerConfiguration(File configurationFile) {
		try {
	 ...
	 * 
	 * @param typeName
	 *            : type name to check. Can be a short name as well as a full
	 *            qualified name
	 * @return true if type name matches with a well known generic container,
	 *         false otherwise
	 */
	public static boolean isWellKnownContainer(String typeName) {
	 ...
	 * 
	 * @param typeName
	 *            a short or full qualified name of the container
	 * @return the cardinality string (as set in containers.xml) or "1" if
	 *         'typeName' is not well known
	 */
	public static String getWellKnownContainerMultiplicityMax(String typeName) {
	...
	public static class ContainerDescription {
		...
		ContainerDescription(String containerName, String cardinality,
				int typeIndex) {
