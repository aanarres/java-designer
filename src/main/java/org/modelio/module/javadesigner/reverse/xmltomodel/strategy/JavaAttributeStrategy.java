...
public class JavaAttributeStrategy extends AttributStrategy {
    ...
    public JavaAttributeStrategy(IModelingSession session) {
        super(session);
    }

    @Override
    public Attribute getCorrespondingElement(JaxbAttribute jaxb_element, MObject owner, IReadOnlyRepository repository) {
        if (owner instanceof Classifier) {
            ...
            try {
                ...
                JavaDesignerModule.logService.error(nfe);
            }
        }
    ...
    @Override
    public List<MObject> updateProperties(JaxbAttribute jaxb_element, Attribute modelio_element, MObject owner, IReadOnlyRepository repository) {
     ...
     */
    private void handleMultipleTags(JaxbAttribute jaxb_element) {
    ...
    @Override
    public void postTreatment(JaxbAttribute jaxb_element, Attribute modelio_element, IReadOnlyRepository repository) {
