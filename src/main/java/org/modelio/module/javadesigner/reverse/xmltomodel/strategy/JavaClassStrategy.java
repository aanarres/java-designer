...
public class JavaClassStrategy extends ClassStrategy {
    ...
    public JavaClassStrategy(IModelingSession session, ReverseStrategyConfiguration reverseConfig) {
        super (session);
        this.reverseConfig = reverseConfig;
    }

    @Override
    public List<MObject> updateProperties(JaxbClass jaxb_element, Class modelio_element, MObject owner, IReadOnlyRepository repository) {
        ...
        try {
            ...
            JavaDesignerModule.logService.error(Messages.getString ("Error.StereotypeNotFound", JavaDesignerStereotypes.JAVACLASS)); //$NON-NLS-1$
        }
     ...
     */
    private void handleMultipleTags(JaxbClass jaxb_element, Class modelio_element, IReadOnlyRepository repository) {
    ...
    @Override
    public void postTreatment(JaxbClass jaxb_element, Class modelio_element, IReadOnlyRepository repository) {
    ...
    private void computeJavaDoc(Class modelio_element, IReadOnlyRepository repository) throws ExtensionNotFoundException {
        String noteType;
    ...
    @Override
    public void deleteSubElements(JaxbClass jaxb_element, Class modelio_element, Collection<MObject> element_todelete, IReadOnlyRepository repository) {
